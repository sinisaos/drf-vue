          ...
          <b-form @submit.prevent="register" class="w-100">
            ...
            <div class="form-group">
              ...
              <div v-if="$v.passwordConfirmation.$error" class="invalid-feedback">
                <span v-if="!$v.passwordConfirmation.required">Confirm Password is required</span>
                <span v-else-if="!$v.passwordConfirmation.sameAsPassword">Passwords must match</span>
              </div>
            </div>
            <div class="form-group">
